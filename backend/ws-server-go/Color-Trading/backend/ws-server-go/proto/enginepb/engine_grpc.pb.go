...
const (
	EngineService_RequestPlaceBet_FullMethodName = "/engine.EngineService/RequestPlaceBet"
)
...
type EngineServiceClient interface {
	RequestPlaceBet(ctx context.Context, in *PlaceBetRequest, opts ...grpc.CallOption) (*PlaceBetResponse, error)
}
...
func (c *engineServiceClient) RequestPlaceBet(ctx context.Context, in *PlaceBetRequest, opts ...grpc.CallOption) (*PlaceBetResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PlaceBetResponse)
	err := c.cc.Invoke(ctx, EngineService_RequestPlaceBet_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type EngineServiceServer interface {
	RequestPlaceBet(context.Context, *PlaceBetRequest) (*PlaceBetResponse, error)
...
func (UnimplementedEngineServiceServer) RequestPlaceBet(context.Context, *PlaceBetRequest) (*PlaceBetResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method RequestPlaceBet not implemented")
}
...
func _EngineService_RequestPlaceBet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PlaceBetRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EngineServiceServer).RequestPlaceBet(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EngineService_RequestPlaceBet_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EngineServiceServer).RequestPlaceBet(ctx, req.(*PlaceBetRequest))
	}
...
var EngineService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "RequestPlaceBet",
			Handler:    _EngineService_RequestPlaceBet_Handler,
		},
	},
